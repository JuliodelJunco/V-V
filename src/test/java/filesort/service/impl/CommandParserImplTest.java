...
class CommandParserImplTest {
    ...
    @Test
    void TC21_parse_NullLine_ThrowsException() {
    ...
    @Test
    void TC28_parse_ReverseAlphabetical_ReturnsSortTypeAndCriteria() {
    ...
    @Test
    void TC29_parse_Created_ReturnsSortTypeAndCriteria() {
    ...
    @Test
    void TC30_parse_ReverseCreated_ReturnsSortTypeAndCriteria() {
    ...
    @Test
    void TC31_parse_Modified_ReturnsSortTypeAndCriteria() {
    ...
    @Test
    void TC32_parse_ReverseModified_ReturnsSortTypeAndCriteria() {
    ...
    @Test
    void TC33_parse_UnknownCommand_ThrowsException() {
